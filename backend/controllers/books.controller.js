 ...
 * @param {Object} req - Request from client side
 * @param {Object} res - Response generated by the function
 * @returns response status with a newBook object
 */
 ...
 * @param {Object} req 
 * @param {Object} res 
 * @returns status code with a json message of book details
 */
 ...
 * @param {Object} req 
 * @param {Object} res 
 * @returns response whether the book has been edited or not
 */
...
module.exports = {
    getBooks, addBook, getById, updateBook, deleteBook, deleteAllBooks
 }