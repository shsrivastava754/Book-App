 ...
 * @returns status code with a message if the book has been added to cart or not
 */
 ...
 * @param {Object} req 
 * @param {Object} res 
 * @returns cart items of the user
 */
 ...
 * @param {Object} req 
 * @param {Object} res 
 * @returns status code with a success message or error message
 */
 ...
 * @param {Object} req 
 * @param {Object} res 
 * @returns a status code if the collection is cleared or not
 */
 ...
 * @param {Object} req 
 * @param {Object} res 
 * @returns a status code if the item is deleted from the cart or not
 */
...
module.exports = {
    addToCart, getCartItems, clearCart, clearCartModel, deleteItem
 }